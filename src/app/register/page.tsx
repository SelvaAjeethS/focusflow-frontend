                ...
                <div className="max-w-[400px] w-full">
                    <div className="text-center mb-6 sm:mb-8">
                        ...
                        <p className="text-text-secondary text-sm sm:text-base">
                            Join FocusFlow and start managing your tasks
                        </p>
                    </div>
                    ...
                    <div className="bg-card border border-border rounded-xl shadow-lg p-6 sm:p-8">
                        ...
                        <div className="mt-8 pt-6 border-t border-border text-center">
                            <p className="text-sm text-text-secondary">
                                ...
                                <Link href="/login" className="text-primary hover:text-primary-hover font-semibold transition-colors duration-200">
                                    Sign in
                                </Link>
                            </p>
                        </div>
